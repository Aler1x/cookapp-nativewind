...
const badgeVariants = cva('flex flex-row items-center rounded-full px-2 py-1 text-xs font-semibold', {
  variants: {
    variant: {
      default: 'bg-primary',
...
const badgeTextVariants = cva('text-center text-xs font-medium', {
  variants: {
    variant: {
